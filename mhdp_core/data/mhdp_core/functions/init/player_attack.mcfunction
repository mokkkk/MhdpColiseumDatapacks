...
# 0：大剣
    data modify storage mh_dp:player_data AttackList append value []
        # 0_溜め斬り0
        data modify storage mh_dp:player_data AttackList[0] append value {Damage:160,ElementDamage:100,Type:1,Offhand:0b}
        # 1_溜め斬り1
        ...
        # 8_薙ぎ払い
        data modify storage mh_dp:player_data AttackList[0] append value {Damage:160,ElementDamage:120,Type:1,Offhand:0b}
        # 9_ハンティングエッジ
        data modify storage mh_dp:player_data AttackList[0] append value {Damage:180,ElementDamage:100,Type:1,Offhand:0b}
...
# 1：片手剣
    data modify storage mh_dp:player_data AttackList append value []
        # 0_突進斬り
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:100,ElementDamage:150,Type:1,Offhand:0b}
        # 1_シールドバッシュ
        ...
        # 3_回転斬り
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:140,ElementDamage:180,Type:1,Offhand:0b}
        # 4_溜め斬り
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:200,ElementDamage:180,Type:1,Offhand:0b}
        # 5_駆け上がり斬り
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:50,ElementDamage:100,Type:1,Offhand:0b}
        # 6_フォールバッシュ
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:250,ElementDamage:0,Type:2,Offhand:1b}
        # 7_ジャストラッシュ1段目
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:100,ElementDamage:100,Type:1,Offhand:0b}
        # 8_ジャストラッシュ2段目_盾攻撃
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:100,DamageJust:200,ElementDamage:0,ElementDamageJust:0,Type:2,Offhand:1b}
        # 9_ジャストラッシュ2段目_剣攻撃
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:120,DamageJust:180,ElementDamage:100,ElementDamageJust:160,Type:1,Offhand:0b}
        # 10_ジャストラッシュ3段目
        ...
        # 11_ジャストラッシュ4段目_剣攻撃1
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:120,DamageJust:220,ElementDamage:150,ElementDamageJust:250,Type:1,Offhand:0b}
        # 12_ジャストラッシュ4段目_剣攻撃2
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:100,DamageJust:140,ElementDamage:100,ElementDamageJust:160,Type:1,Offhand:0b}
        # 13_飛影
        data modify storage mh_dp:player_data AttackList[1] append value {Damage:100,ElementDamage:150,Type:1,Offhand:0b}
        # 14_滅・昇竜撃
...
# 2：太刀
    data modify storage mh_dp:player_data AttackList append value []
        ...
        # 1_気刃斬り1_失敗
        data modify storage mh_dp:player_data AttackList[2] append value {Damage:80,ElementDamage:70,Type:1,Offhand:0b}
        # 2_気刃斬り1
        data modify storage mh_dp:player_data AttackList[2] append value {Damage:120,ElementDamage:100,Type:1,Offhand:0b}
        # 3_斬り下がり
        data modify storage mh_dp:player_data AttackList[2] append value {Damage:90,ElementDamage:80,Type:1,Offhand:0b}
        # 4_気刃斬り2
