#> mhdp_weapons:weapon/long_sword/12_serene_pose/animation_0
#
# 太刀：踏み込み アイテムアニメーション
...
# 武器ステータス変更
    ...
    # Cmd計算
        ...
        scoreboard players add #mhdp_temp_cmd MhdpCore 22
    ...
    item modify entity @s weapon.mainhand mhdp_core:const/long_sword/no_attack
