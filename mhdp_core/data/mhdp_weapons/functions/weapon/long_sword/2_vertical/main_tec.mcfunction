#> mhdp_weapons:weapon/long_sword/2_vertical/main_tec
#
# 太刀：踏み込み斬り
...
# 遷移
    ...
    # スニーク+ジャンプ時，見切り斬りに移行
        execute if entity @s[tag=PlyJumpping,tag=PlySneakCurrent,scores={MhdpWeaponTimer=13..30}] run function mhdp_weapons:weapon/long_sword/2_vertical/change_foresight
