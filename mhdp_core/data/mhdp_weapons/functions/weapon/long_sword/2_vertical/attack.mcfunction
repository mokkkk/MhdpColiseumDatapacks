...
# ダメージ発生
    ...
    execute if entity @s[tag=!PlySkillTechnical] if entity @e[tag=Targets] run scoreboard players add @s MhdpWeaponSpiritGaugeLsword 70
    execute if entity @s[tag=PlySkillTechnical] if entity @e[tag=Targets] run scoreboard players add @s MhdpWeaponSpiritGaugeLsword 140
