#> mhdp_weapons:weapon/long_sword/97_draw/
#
# 太刀の抜刀処理
#
...
# 武器ステータス変更
    ...
    item modify entity @s weapon.mainhand mhdp_core:const/long_sword/draw
# サブ武器抜刀
    ...
    item modify entity @s weapon.offhand mhdp_core:const/long_sword/draw_sub
# プレイヤーデータ書き換え
