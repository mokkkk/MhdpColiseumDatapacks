...
# 倍率計算
    execute store result score #mhdp_temp_damage_mult MhdpCore run data get storage mh_dp:player_data AttackList[0][10].Damage 1
    execute store result score #mhdp_temp_element_damage_mult MhdpCore run data get storage mh_dp:player_data AttackList[0][10].ElementDamage 1
