...
# 怒りカウント
    ...
    execute if entity @s[tag=StateIsAnger] if score #mhdp_reus_anger_count AsaMatrix matches 50.. run function reus:manager/6_damage_animation/2_anger/end
