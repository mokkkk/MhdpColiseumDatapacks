...
# summon slime ~ ~ ~ {NoGravity:1b,Silent:1b,NoAI:1b,Health:1000f,Size:2,Tags:["MonsterParts","RanposuHealth","RanposuParts","Head","HeadParts"],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.knockback_resistance",Base:1}],DeathLootTable:"asa_animator:no_drop",ActiveEffects:[{Id:14,Amplifier:1b,Duration:6000000,ShowParticles:0b}],PersistenceRequired:1b}
...
# Tsbライブラリ用init
    function ranposu:manager/0_init/2_library/
