...
# 部位破壊時
    execute if entity @s[tag=StateBreakHead] on passengers if entity @s[tag=aj.ranposu.bone.head_upper] run data modify entity @s item.tag.CustomModelData set value 100001
