...
# 移動
    execute if score @s aj.ranposu.animation.bite.local_anim_time matches 1..3 positioned as @s run tp @s ^ ^ ^-0.1 ~ 0
    execute if score @s aj.ranposu.animation.bite.local_anim_time matches 10..15 positioned ^ ^2 ^5 unless entity @e[tag=RanposuTarget,distance=..3.5] positioned as @s run tp @s ^ ^ ^0.2 ~ 0
    execute if score @s aj.ranposu.animation.bite.local_anim_time matches 30..32 positioned as @s run tp @s ^ ^ ^-0.02 ~ 0
