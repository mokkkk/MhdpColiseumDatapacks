...
scoreboard players set $aj.reus.animation.land_breath aj.id 11
scoreboard players set $aj.reus.animation.fly_idle aj.id 12
scoreboard players set $aj.reus.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.reus.export_version aj.i -1052054803
