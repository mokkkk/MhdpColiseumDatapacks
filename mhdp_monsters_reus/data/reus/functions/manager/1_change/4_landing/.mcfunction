...
# 近
    execute if predicate reus:animation/is_stay_animation_tags if entity @e[tag=ReusAttackTarget,distance=..8] run function reus:manager/1_change/4_landing/near

# 中
    execute if predicate reus:animation/is_stay_animation_tags if entity @e[tag=ReusAttackTarget,distance=..18] run function reus:manager/1_change/4_landing/middle
