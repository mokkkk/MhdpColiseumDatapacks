#> ranposu:manager/1_change/check_pos
#
# 青鳥竜 プレイヤーとの位置関係取得

# 前方
    execute rotated as @s rotated ~ 0 positioned 0 0 0 run summon marker ^ ^ ^1 {Tags:["MhdpRotater","MhdpPos0"]}
    execute facing entity @e[tag=RanposuAttackTarget,limit=1] feet rotated ~ 0 positioned 0 0 0 run summon marker ^ ^ ^1 {Tags:["MhdpRotater","MhdpPos1"]}
