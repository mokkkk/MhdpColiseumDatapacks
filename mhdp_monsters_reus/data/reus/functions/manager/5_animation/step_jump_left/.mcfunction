...
# 移動
    ...
    execute if score @s aj.ranposu.animation.step_jump_left.local_anim_time matches 1..18 at @s run tp @s ^0.8 ^ ^ ~ 0
    execute if score @s aj.ranposu.animation.step_jump_left.local_anim_time matches 19..23 at @s run tp @s ^0.1 ^ ^ ~ 0
