...
# まばたき
    execute if entity @s[tag=StateIsStun] if score @s aj.reus.animation.land_down_l.local_anim_time matches 1 run function reus:manager/7_model/head_blink
    execute if score @s aj.reus.animation.land_down_l.local_anim_time matches 20 run function reus:manager/7_model/head_blink
    execute if entity @s[tag=!StateIsStun] if score @s aj.reus.animation.land_down_l.local_anim_time matches 34 run function reus:manager/7_model/head_blink_end
