...
# 演出
    ...
    execute if score @s aj.reus.animation.land_voice.local_anim_time matches 44..75 at @e[type=marker,tag=LctPosHead,limit=1,sort=nearest] run particle flash ~ ~ ~ 0 0 0 0 1
