...
# markerセット
summon marker ^ ^ ^12 {Tags:["ReusMovePos"]}
execute rotated ~ 0 positioned ^ ^2 ^8 run tp @e[type=marker,tag=ReusMovePos] ~ ~ ~
...
execute as @e[type=marker,tag=ReusMovePos] at @s run tp @s ~ ~2 ~
