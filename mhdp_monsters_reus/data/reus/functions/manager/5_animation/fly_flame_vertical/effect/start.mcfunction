...
# 演出
    execute as @e[type=marker,tag=ReusFlyFlameAttack,limit=1] at @s run function reus:manager/5_animation/fly_flame_vertical/effect/shot
    execute as @e[type=marker,tag=ReusFlyFlameAttack,limit=1] at @s run function reus:manager/5_animation/fly_flame_vertical/effect/loop
