...
# ターゲット設定・演出
    execute on passengers if entity @s[tag=LctPosHead] on origin at @s facing entity @e[type=area_effect_cloud,tag=ReusBreathTarget,limit=1] feet run function reus:manager/5_animation/fly_flame_sweep/effect/start
