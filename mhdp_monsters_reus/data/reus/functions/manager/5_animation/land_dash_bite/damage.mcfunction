...
# ダメージ設定
    data modify storage mhdp_core:temp Temp.Damage set from storage mh_dp:monster_data AttackList[1][0]
...
# 攻撃処理
    execute as @e[tag=Target] run function reus:manager/5_animation/land_dash_bite/damage_sub
