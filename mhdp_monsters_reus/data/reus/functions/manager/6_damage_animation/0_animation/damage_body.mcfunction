#> reus:manager/6_damage_animation/0_animation/damage_body
#
# 青鳥竜 怯み処理 頭
...
# アニメーション遷移
    ...
    execute if entity @s[tag=!StateIsFlying] run function animated_java:reus/animations/land_damage_body/play
    execute if entity @s[tag=!StateIsFlying] facing entity @p feet run tp @s ~ ~ ~ ~ 0
...
# 部位破壊処理
    execute if entity @s[tag=!StateBreakBody] run function reus:manager/6_damage_animation/1_break/body
